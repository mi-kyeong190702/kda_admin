				...
				onSelectRow: function(ids) {
					if(ids == null) {
						...
						if(id){
							...
							opener.document.mem.lt_post.value=ret.zipNo;
							opener.document.mem.lt_add.value=ret.lnmAdres;
							self.close();
						}
						else {}
					}
...
function tsearch(){	
	...
	$('#list').jqGrid('clearGridData');
	jQuery("#list").setGridParam({url:"lecture.do?method=postSearchr&sel=Y&keyword="+keyword+"&searchSe="+searchSe}).trigger("reloadGrid"); 
}
</script>
</head>
<body>
