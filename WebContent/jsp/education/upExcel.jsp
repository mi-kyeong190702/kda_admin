...
<body> 
<form name="upFile" method="post" enctype="multipart/form-data" action="education.do?method=examSendListUpExcel" >
          ...
          <caption>회원검색</caption>          
            ...
            <tr> 
            	<td class="mtbl1" colspan="4">
					<input type="file" name="attatch" size="20" id="attatch" />
