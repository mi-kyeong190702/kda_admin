...
function upExcel(){
	...
	alert("업로드중입니다.\r\n확인 버튼을 누르신 후 잠시 기다려 주세요.");
}
</script>
</head>
<body> 
<form name="upFile" method="post" enctype="multipart/form-data" action="education.do?method=educationSendListUpExcel" >
          ...
          <caption>회원검색</caption>          
            ...
            <tr> 
            	<td class="mtbl1" colspan="4">
					<input type="file" name="attatch" size="18" id="attatch" />
					<input type="button" name="upload" value="업로드"  onclick="javascript:upExcel();"><br><br>
					1. 파일은 한 개만 첨부 가능합니다.<br>
					2. 첨부 가능한 파일의 용량은 10MB입니다.<br>
					3. 업로드 버튼을 클릭하시면 작업이 시작됩니다.
					</td>                         
             </tr>
            </tbody>
          </table>       
