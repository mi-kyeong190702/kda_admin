...
<form action="" method="post">
	...
	<div id="contents">
	  <ul class="home">
		...
		<li>&gt;</li>
		<li class="NPage">문항검색</li>
	  </ul>
	  <div id="ts_tabmenu">
        <ul>
	      <li><a href="/main3.10.do"><strong><span>문항등록</span></strong></a></li>
	      <li><a href="#" class="overMenu"><strong><span>문항검색</span></strong></a></li>	 
        </ul>
      </div>
	  <div class="eTabmenu_01">        
		<table class="etable_04" cellspacing="0" summary="문항관리">
          <caption>문항검색</caption>            		 
			 <tr>
               <td class="nobg">년도</td>
               <td class="nobg1"><input type="text" id="m" size="15" /></td>
               <td class="nobg2">분기</td>
               <td class="nobg1"><input type="text" id="m" size="15" /></td>
		...
		<p class="btnSave"><a href="#"><img src="images/icon_search.gif" alt="검색" /></a></p>	  
 </form>
 <br>
 <table id="list"></table>
<div id="pager2"></div>
<form name="sForm2" method="post"></form>
<p class="btnSave"><img src="images/icon_excel.gif" alt="엑설저장" /></a></p>
 </div><!--rTabmenu_01 End-->
	</div><!--contents End-->	
