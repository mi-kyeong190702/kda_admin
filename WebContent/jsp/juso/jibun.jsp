	...
	<div id="container">
		<div id="content">
			<ul class="tab">
				...
				<li><a href="#n" onclick="selectSearch('jibun','<%=sel %>');return false;"><img src="jsp/juso/img/tab2.gif" alt="지번"/></a></li>
				...
				<form name="check" method="post">
					...
					<fieldset>
						...
						<div class="btn">
							<a href="#"><img src="jsp/juso/img/btn_search.gif" alt="검색" onclick="normalSearch('jibun','1');return false;" /></a>
						</div>
						<div >
