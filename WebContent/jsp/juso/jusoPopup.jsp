...
%>
<script type="text/javascript" src="jsp/juso/js/jquery-1.12.4.min.js"></script>
<script type="text/javascript" src="jsp/juso/js/addrlink.js"></script>
<link rel="stylesheet" type="text/css" href="jsp/juso/css/addrlink.css"></link>
...
<script language="javascript">
    ...
    function setParent(){
      ...
      //18.03.18 지번주소 제거
        <% if ( "1".equals(gubun) ) { %>
        opener.jusoCallBack1(rtRoadFullAddr, rtAddrPart1, rtAddrDetail, rtAddrPart2, rtEngAddr, rtJibunAddr, rtZipNo, rtAdmCd, rtRnMgtSn, rtBdMgtSn, rtDetBdNmList, rtBdNm, rtBdKdcd, rtSiNm, rtSggNm, rtEmdNm, rtLiNm, rtRn, rtUdrtYn, rtBuldMnnm, rtBuldSlno, rtMtYn, rtLnbrMnnm, rtLnbrSlno, rtEmdNo);
