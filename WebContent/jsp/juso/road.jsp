...
<title>::도로명주소검색::</title>
<link type="text/css" href="jsp/juso/style.css" rel="stylesheet"></link>
<script src="jsp/juso/juso.js" type="text/javascript"></script>
<script type="text/javascript"> 
	...
	if (document.domain.toString().indexOf("<%=WorkData.HOME_DOMAIN%>") != -1) document.domain="<%=WorkData.HOME_DOMAIN%>";
	if (document.domain.toString().indexOf("<%=WorkData.HOME_IP%>") != -1) document.domain="<%=WorkData.HOME_DOMAIN%>"; // DEV_CHANGE
   ...
   function changeAreaList(idx, obj){	
		...
		var url = "memberBasic.do?method=postAjax&getUrl=https://www.juso.go.kr/getAreaCode.do?" + escape(createParameter());
			        ...
			        for(var i = 0; i < sggNm.length; i++) {
						...
						if(i%2=='0'){
							document.getElementById("formbox").innerHTML += "<ul class='item'>";
			 				document.getElementById("formbox").innerHTML += "<li class='road'><a href='javascript:setParentValue(\""+ newaddr+"*"+setDetailJuso+"*"+zip+"*"+<%=sel%>+"\")'>"+"[도로명]"+newaddr+"</a></li>";
					 		...
					 		document.getElementById("formbox").innerHTML += "<ul class='item'>";
					 		document.getElementById("formbox").innerHTML += "<li class='road2'><a href='javascript:setParentValue(\""+ newaddr+"*"+setDetailJuso+"*"+zip+"*"+<%=sel%>+"\")'>"+"[도로명]"+newaddr+"</a></li>";
...
<div id="wrapper">
	<div id="header">
		<h1>
			<img src="jsp/juso/img/h1.jpg" alt="도로명주소찾기(우편번호)" />
		</h1>
	</div>
	<div id="container">
		<div id="content">
			<ul class="tab">
				<li><a href="#n" onclick="selectSearch('road','<%=sel %>');return false;"><img src="jsp/juso/img/tab1.gif" alt="도로명주소"/></a></li>
				<li><a href="#n" onclick="selectSearch('jibun','<%=sel %>');return false;"><img src="jsp/juso/img/tab2_off.gif" alt="지번"/></a></li>
				<li><a href="#n" onclick="selectSearch('sangho','<%=sel %>');return false;"><img src="jsp/juso/img/tab3_off.gif" alt="건물명"/></a></li>
			</ul>
				...
				<form name="check" method="post">
					...
					<fieldset>
						...
						<div class="btn">
							<a href="#"><img src="jsp/juso/img/btn_search.gif" alt="검색" onclick="normalSearch('road','1');return false;" /></a>
						</div>
						<div >
							<img src="jsp/juso/img/test.gif" alt="" width="380px" />
							자세한 표기법은   <a href="https://www.juso.go.kr" style="font-size: 10px" target="_blank">도로명주소안내홈페이지</a> 를 참조하세요
						</div>
					</fieldset>
					</div>
				</form>
