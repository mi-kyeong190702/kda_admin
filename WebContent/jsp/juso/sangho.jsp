...
<title>::건물명검색::</title>
<link type="text/css" href="jsp/juso/style.css" rel="stylesheet" />
...
<div id="wrapper">
	...
	<div id="container">
		<div id="content">
			<ul class="tab">
				<li><a href="#n" onclick="selectSearch('road','<%=sel %>');return false;"><img src="jsp/juso/img/tab1_off.gif" alt="도로명주소"/></a></li>
				<li><a href="#n" onclick="selectSearch('jibun','<%=sel %>');return false;"><img src="jsp/juso/img/tab2_off.gif" alt="지번"/></a></li>
				<li><a href="#n" onclick="selectSearch('sangho','<%=sel %>');return false;"><img src="jsp/juso/img/tab3.gif" alt="건물명"/></a></li>
			</ul>
				...
				<div class="form" id="formbox">
					<fieldset>
						...
						<div class="btn">
							<a href="#"><img src="jsp/juso/img/btn_search.gif" alt="검색" onclick="normalSearch('sangho','1');return false;" /></a>
						</div>
						<div >
