...
jQuery("#list").jqGrid({
      url: "memberInsert.do?method=compostSearch&sel=Y",
      datatype: "json",
      mtype: 'POST',
      height:'260',
      width:'650',
				...
				onSelectRow: function(ids) {
					if(ids == null) {
						...
						if(id){
							...
							opener.document.comp.company_code_post.value=ret.zipNo;
							opener.document.comp.company_add.value=ret.lnmAdres;
							opener.document.comp.company_add_detail.value="";
...
function tsearch(){	
	...
	$('#list').jqGrid('clearGridData');
	jQuery("#list").setGridParam({url:"memberInsert.do?method=compostSearchr&sel=Y&keyword="+keyword+"&searchSe="+searchSe}).trigger("reloadGrid"); 
}
</script>
</head>
<body>
