...
jQuery("#list").jqGrid({
      url: "memberInsert.do?method=postSearch&sel=Y",
      datatype: "json",
      mtype: 'POST',
      height:'260',
      width:'650',
				...
				onSelectRow: function(ids) {
					if(ids == null) {
						...
						if(id){
							...
							opener.document.comp.code_post.value=ret.zipNo;
							opener.document.comp.pers_add.value=ret.lnmAdres;
							opener.document.comp.pers_add_detail.value="";
							opener.document.comp.code_add_gubun.aNew.checked='true';
							self.close();
						}
						else {}
					}
...
function tsearch(){	
	...
	$('#list').jqGrid('clearGridData');
	jQuery("#list").setGridParam({url:"memberInsert.do?method=postSearchr&sel=Y&keyword="+keyword+"&searchSe="+searchSe}).trigger("reloadGrid"); 
}
</script>
</head>
<body>
