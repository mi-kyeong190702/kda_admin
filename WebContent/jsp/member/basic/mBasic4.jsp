...
<% 
		request.setCharacterEncoding("utf-8"); 
	  	...
	  	String url="memberBasic.do?method=eduList&pCode="+pCode;
...
jQuery("#list").jqGrid({
      ...
      height:'410',
      width:'1097',
      colNames: ['교육년도','교육구분','교육명','교육시작일','교육종료일','이수점수','출석일수','이수시간','상태','상태변경일'],
      colModel: [
			{name:'yyyy',			index:'yyyy', 			width:20, 	sortable:false, align:'center'},
			{name:'code_kind',		index:'code_kind', 		width:40, 	sortable:false, align:'center'},
			{name:'edutest_name',	index:'edutest_name', 	width:100, 	sortable:false},
   			{name:'oper_start_dt',	index:'oper_start_dt', 	width:30,	sortable:false, align:'center'},
   			{name:'oper_end_dt',	index:'oper_end_dt', 	width:30,	sortable:false, align:'center'},
   			{name:'result_point',	index:'result_point', 	width:20,	sortable:false, align:'center'},
   			{name:'attend_cnt',		index:'attend_cnt', 	width:20,	sortable:false, align:'center'},
   			{name:'time_cnt',		index:'time_cnt', 		width:20,	sortable:false, align:'center'},
   			{name:'result_state',	index:'result_state', 	width:20,	sortable:false, align:'center'},
   			{name:'up_date',		index:'up_date', 		width:50, 	sortable:false, align:'center',formatter:'date',formatoptions:{srcformat:'Y-m-d H:i:s',newformat:'Y-m-d'}}   			
                ],
                rowNum:100000,
                pager: '#pager2',
                grouping:true,
                groupingView:{
                	groupField : ['code_kind'],
	   ...
	   <div class="mTabmenu">
	    <div id="ts_tabmenu">
          <ul>
	        ...
	        <li><a href="#" class="overMenu"><strong><span>교육</span></strong></a></li>
