...
.myAltRowClass {background-color:#f5f8f9; background-image:none;}
		...
		<script type="text/javascript">
			$(document).ready(function(){
				...
				//전체 권한 여부
				powerinit("123", eval(<%=userpowerm1%>) );


				
				jQuery("#list").jqGrid({
					url: "memberState.do?method=yearPayStateList",
						datatype: "json",
						mtype: 'POST',
						height:'500',
						width:'1100',
						colNames: [ '대분류','대분류','소분류','소분류','1100~1199','1200~1399','1400~1599','1600~1799','1800~1999','합계'],
						colModel: [
		...
		<script>
			...
			function goSearch(form){
				...
				jQuery("#list").setGridParam({url:"memberState.do?method=yearPayStateList&startdate="+startdate+"&enddate="+enddate}).trigger("reloadGrid"); 
			...
			function excelDown(form) {
				...
				form.target="frm";
				form.action="memberState.do?method=yearPayStateExcel"+param;
				form.submit();
