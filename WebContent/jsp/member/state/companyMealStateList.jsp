...
.myAltRowClass {background-color:#f5f8f9; background-image:none;}
		...
		<script type="text/javascript">
			$(document).ready(function(){
				...
				//전체 권한 여부
				powerinit("126", eval(<%=userpowerm1%>) );

				
				jQuery("#list").jqGrid({
					url: "memberState.do?method=companyMealStateList",
					datatype: "json",
					mtype: 'POST',
					height:'500',
					width:'1100',
		...
		<script>
			...
			function goSearch(form){
				...
				jQuery("#list").setGridParam({url:"memberState.do?method=companyMealStateList&startdate="+startdate+"&enddate="+enddate}).trigger("reloadGrid"); 
			...
			function excelDown(form) {
				...
				form.target="frm";
				form.action="memberState.do?method=companyMealStateExcel"+param;
				form.submit();
