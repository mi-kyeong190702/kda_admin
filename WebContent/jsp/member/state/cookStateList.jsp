...
.myAltRowClass {background-color:#f5f8f9; background-image:none;}
		...
		function init(){
			...
			$(document).ready(function(){
				...
				jQuery("#list").jqGrid({
					url: "memberState.do?method=cookStateList",
						datatype: "json",
						mtype: 'POST',
						height:'500',
						width:'1100',
		...
		<script>
			...
			function goSearch(form){
				...
				if(startdate > enddate){
					...
					jQuery("#list").setGridParam({url:"memberState.do?method=cookStateList&startdate="+startdate+"&enddate="+enddate}).trigger("reloadGrid"); 
				}
			}
			function excelDown(){	
				if(document.memberStateInputForm.yn.value=='n'){
					...
					document.memberStateListForm.action="memberState.do?method=cookStateDown";
