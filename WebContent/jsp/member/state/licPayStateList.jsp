...
.myAltRowClass {background-color:#f5f8f9; background-image:none;}
		...
		<script type="text/javascript">
			$(document).ready(function(){
				...
				//전체 권한 여부
				powerinit("125", eval(<%=userpowerm1%>) );


				
				jQuery("#list").jqGrid({
					url: "memberState.do?method=licPayStateList",
					datatype: "json",
					mtype: 'POST',
					height:'500',
					width:'1100',
					colNames: [ '대분류','대분류','소분류','소분류','20000~29999','30000~39999','40000~49999','50000~59999','60000~69999','합계'],
					colModel: [
		...
		<script>
			...
			function goSearch(form){
				...
				jQuery("#list").setGridParam({url:"memberState.do?method=licPayStateList&startdate="+startdate+"&enddate="+enddate}).trigger("reloadGrid"); 
			...
			function excelDown(form) {
				...
				form.target="frm";
				form.action="memberState.do?method=licPayStateExcel"+param;
				form.submit();
