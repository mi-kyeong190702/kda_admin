...
<body> 
<form name="upFile" method="post" enctype="multipart/form-data" action="license.do?method=conditionSendListUpExcel" >
 ...
 <input type="button" value="창닫기" onclick="javascript:clo();" />
