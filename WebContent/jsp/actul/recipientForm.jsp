...
<script>
	...
	function fileDown(num){
		...
		if(num == 1 ){
			fileUrl = recipientFrm.cs_attachments_url.value;
			fileName = recipientFrm.cs_attachments.value;
		}
		else if(num == 2){
			fileUrl = recipientFrm.cs_attachments_url2.value;
			fileName = recipientFrm.cs_attachments2.value;
		}
		else {
			fileUrl = recipientFrm.cs_attachments_url3.value;
			fileName = recipientFrm.cs_attachments3.value;
		}
...
<input type="hidden" name="cs_attachments_url" id="cs_attachments_url" value="${result[0].cs_attachments_url}">
<input type="hidden" name="cs_attachments" id="cs_attachments" value="${result[0].cs_attachments}">
<input type="hidden" name="cs_attachments_url2" id="cs_attachments_url2" value="${result[0].cs_attachments_url2}">
<input type="hidden" name="cs_attachments2" id="cs_attachments2" value="${result[0].cs_attachments2}">
<input type="hidden" name="cs_attachments_url3" id="cs_attachments_url3" value="${result[0].cs_attachments_url3}">
<input type="hidden" name="cs_attachments3" id="cs_attachments3" value="${result[0].cs_attachments3}">
...
<!-- 									</div> -->
									...
									<div class="f_wrap line bb p8">
										<div class="f_field div2">
											<label for="cs_con_education" class="ff_title i_b"><strong>보수교육 미대상자 신청연도</strong></label>
												...
												<div class="area">
													<ul>
														...
														<li class="mt5">
															...
															<label for="radio3_3">2. 미취업, 대학 재학중, 면허미취득, 면허 취득 후 임신, 출산 등으로 인한 퇴직, 취업경험 없음 등</label>
								...
								<div class="form mt10 line bt bcm">
									<div class="f_wrap line bb p8">
										<div class="f_field div1">
											...
											<div class="ff_wrap ml130">
												<div class="area">
													${result[0].cs_attachments}&nbsp;<a href="javascript:fileDown(1);"><img src="images/icon_s13.gif" alt="첨부문서다운"/></a>
												</div>
											</div>
										</div>
									</div>
								...
								<div class="form mt10 line bt bcm">
									<div class="f_wrap line bb p8">
										<div class="f_field div1">
											...
											<div class="ff_wrap ml130">
												<div class="area">
													${result[0].cs_attachments2}&nbsp;<a href="javascript:fileDown(2);"><img src="images/icon_s13.gif" alt="첨부문서다운"/></a>
												</div>
											</div>
										</div>
									</div>
								...
								<div class="form mt10 line bt bcm">
									<div class="f_wrap line bb p8">
										<div class="f_field div1">
											...
											<div class="ff_wrap ml130">
												<div class="area">
													${result[0].cs_attachments3}&nbsp;<a href="javascript:fileDown(3);"><img src="images/icon_s13.gif" alt="첨부문서다운"/></a>
												</div>
											</div>
										</div>
									</div>
