...
<%
	...
	String toAddr=URLDecoder.decode(request.getParameter("to_addr"	),"UTF-8");
...
<body>
<form name="mail" method="post" action="actul.do?method=SendMail" >
...
<table class="tbl_type" border="1" cellspacing="0" summary="회원검색"> 
	...
	<tr> 
		<td>보내는 사람</td>
		<td>
			<input type="text" name="fr_name1"  size="10" value="실태신고센터">
		</td>
		<td>이메일 주소</td>
		<td>
<!-- <input type="text" name="from1"  size="30" value="kdasys@hanmail.net"> -->
			<!-- <input type="text" name="from1"  size="30" value="kda516@hanmail.net"> -->
			<!-- 2022.09.14 수정 -->
			<input type="text" name="from1"  size="30" value="kda516@kdiet.or.kr">
		</td>
	</tr>
	<tr> 
		<td>제 목</td>
