...
<%
	String yyyy1          =  (String)request.getAttribute("yyyy");
	String ar_lic_no1     =  (String)request.getAttribute("ar_lic_no");
	String msg="";
...
function excelDown(){
	...
	var ar_lic_no        = "";
	 ...
	 yyyy              =  '<%=yyyy1%>';
	 ar_lic_no         =  '<%=ar_lic_no1%>';
	 
	 if( ar_lic_no == "undefined"){
		 alert("회원을 한 명 선택하셔야 저장 받을 수 있습니다.");
		 return;
	 }
	
	document.upFile.target="frm";
	document.upFile.action="actul.do?method=upExcelsample&yyyy="+yyyy+"&ar_lic_no="+ar_lic_no;
...
function upExcel(){
	...
	document.upFile.target="frm";
	//document.upFile.action="actul.do?method=actulupExcel";
	document.upFile.submit();
...
<body> 
<form name="upFile" method="post" enctype="multipart/form-data" action="actul.do?method=actulupExcel" >
	<div id="L_contents" >
	<br>
	<h5>&nbsp;&nbsp;▶보수교육 엑셀 파일 올리기</h5>
	</div>
          ...
          <caption>회원검색</caption>          
            ...
            <tr> 
            	<td class="mtbl1" colspan="4">
					...
					업로드샘플파일 <a href="/upload/보수교육업로드샘플파일.xls">다운</a><br>
					</td>                         
             </tr>             
            </tbody>
          </table>  
