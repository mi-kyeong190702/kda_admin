...
jQuery("#list").jqGrid({
	  url: 'actul.do?method=actulsearchList',
	  datatype: "json",
      mtype: 'post',     
      width:'1100',
      height:'365',
      colNames: [ '년도','순번','이름','주민 번호','면허 번호','지역','지영코드','활동 구분','활동구분코드','근무처 구분','근무처구분코드','이메일','연락처','총 시간','이수 시간','진행 상태','진행상태코드'],
      colModel: [
			{name:'yyyy',              index:'yyyy',              width: 50, editable: false, align: 'center'},
			{name:'yyyy_seq',          index:'yyyy_seq',          hidden:true},
   			{name:'ar_name',           index:'ar_name',           width: 100,editable: false, align: 'center'},
   			{name:'ar_no',             index:'ar_no',             width: 150,editable: false, align: 'center'},
   			{name:'ar_lic_no',         index:'ar_lic_no',         width: 80,editable:  false, align: 'center'},
   			{name:'ar_add1_name', 	   index:'ar_add1_name',      width: 150,editable:  false, align: 'center'},
   			{name:'ar_add1',           index:'ar_add1',           hidden:true},
   			{name:'ar_code_part_name', index:'ar_code_part_name', width: 180,editable:  false, align: 'center'},
   			{name:'ar_code_part',      index:'ar_code_part',      hidden:true},
   			{name:'ar_code_big1-name', index:'ar_code_big1_name', width: 150,editable:  false, align: 'center'},
   			{name:'ar_code_big1',      index:'ar_code_big1',      hidden:true},   			
   			{name:'email',             index:'email',             width: 150,editable:  false, align: 'left'},
   			{name:'ar_tel_hp',         index:'ar_tel_hp',         width: 100,editable:  false, align: 'center'},
   			{name:'ar_finish_point',   index:'ar_finish_point',   width: 80,editable:  false, align: 'center'},		
   			{name:'ar_marks_point',    index:'ar_marks_point',    width: 80,editable:  false, align: 'center'},
   			{name:'ar_state_name',     index:'ar_state_name',     width: 80,editable:  false, align: 'center'},
...
function goSearch(form,intPage){	
	...
	jQuery("#list").setGridParam({url:"actul.do?method=actulsearchList&parm"+parm}).trigger("reloadGrid");
}
...
<form id="list1" name="sForm" method="post">
    <table class="rtable_01" cellspacing="0" summary="영양사실태신고">			
       <!--  <div id="container"> -->
             ...
             <tr>
               <td class="nobg"  size ="12" align="center">신고 년도</td>               			   
			   <td class="nobg1" size ="12" align="center">지역</td>
			   <td class="nobg1" size ="12" align="center">활동 구분 </td>
			   <td class="nobg1" size ="12" align="center">근무처 구분</td>               			   
			   <td class="nobg1" size ="12" align="center">총 시간</td>
			   <td class="nobg1" size ="12" align="center">이수 시간</td>
			   <td class="nobg1" size ="12" align="center">이름</td>
			   <td class="nobg1" size ="12" align="center">상태</td> 			  
			 </tr> 			 
			 <tr>
			  <td class="alt" >
               ...
               <td>
               <select  id="search" name="ar_add11" style="width:120px;">
               <option value="">선택</option>	
              		 <% 
			   ...
			   <td>
               <select  id="search" name="ar_code_part1" style="width:120px;">
               <option value="">선택</option>	
              		 <% 
			   ...
			   <td>
               <select  id="search" name="ar_code_big11" style="width:120px;">
               <option value="">선택</option>	
              		 <% 
			   ...
			   <td><input type="text" id="mail" name="ar_finish_point1"size="12" /></td>
			   <td><input type="text" id="mail" name="ar_marks_point1"  size="12" /></td>                                       
               <td><input type="text" id="name" name="ar_name1" size="12" /></td>
               <td>
               <select  id="search" name="ar_state1" style="width:120px;">
               <option value="">선택</option>	
              		 <% 
                	String detCode4,detCName4=null;
                	for(int i=0;i<comcodesearch.size();i++){
                		if("045".equals(comcodesearch.get(i).get("groupcode").toString())){
