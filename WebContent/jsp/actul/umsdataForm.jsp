...
<%
	...
	ar_tel_hp   	     =  request.getParameter("ar_tel_hp");
	ar_name   	         =  request.getParameter("ar_name");
	yyyy1                =  request.getParameter("yyyy1")          == null?""     :   request.getParameter("yyyy1") + "";	
	ar_add11             =  request.getParameter("ar_add11")       == null?""     :   request.getParameter("ar_add11") + "";	
	ar_code_part1        =  request.getParameter("ar_code_part1")  == null?""     :   request.getParameter("ar_code_part1") + "";	
	ar_code_big11        =  request.getParameter("ar_code_big11")  == null?""     :   request.getParameter("ar_code_big11") + "";					
	ar_state1            =  request.getParameter("ar_state1")      == null?""     :   request.getParameter("ar_state1") + "";	
...
function fn_isrequest(form) {
	...
	function sendDms(){
		...
		document.sForm.action = "actul.do?method=umsData&parm="+parm;
	...
	function sendDmsall(){
		...
		document.sForm.action = "actul.do?method=umsDataall&parm="+parm;
	   	document.sForm.submit();
	   	self.close();		
	}
...
<table class="tbl_type" border="1" cellspacing="0" summary="회원검색" > 
	<tr> 
		...
		<td>
			<input type="text" name="to"  value="<%=ar_tel_hp %>" size="25" readonly="readonly"/>
		</td>
	</tr>
	<tr>
