...
<script type="text/javascript">
	function uploadBtn(){
		...
		opener.frm.old_pers_name.value=frm.old_pers_name.value;
		opener.frm.old_lic_no.value=frm.old_lic_no.value;
		opener.frm.old_lic_print_dt.value=frm.old_lic_print_dt.value;
...
<div class="w450 ac">
	<div class="box t2 mt10 p50 pt30 pb30">
		<div class="area mb20">
			<h4 class="title bold t2 s1"><mark class="cm">면허정보</mark> 수정</h4>
		</div>
		<form name="frm">
			<input type="hidden" name="old_pers_name" value="${pers_name}"/>
			<input type="hidden" name="old_lic_no" value="${lic_no}"/>
			<input type="hidden" name="old_lic_print_dt" value="${lic_print_dt}"/>
			<fieldset>
