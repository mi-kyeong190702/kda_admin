...
jQuery("#list").jqGrid({
      url: "document.do?method=postSearch&sel=Y",
      datatype: "json",
      mtype: 'POST',
      height:'260',
      width:'650',
...
function tsearch(){	
	...
	$('#list').jqGrid('clearGridData');
	jQuery("#list").setGridParam({url:"document.do?method=postSearchr&sel=Y&keyword="+keyword+"&searchSe="+searchSe}).trigger("reloadGrid"); 
}
</script>
</head>
<body>
