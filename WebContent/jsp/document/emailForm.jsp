...
*/
	function sendMail(){
		...
		if(document.mail.from1.value==null||document.mail.from1.value==""){
		...
		//alert(document.mail.fileName.value);
		//alert(document.mail.upYN.value);
		document.mail.submit();
		self.close();
	}
	
	function upFiles(){
		document.mail.fileName.value=document.upFile.attatch.value;
...
<body>
<form name="mail" method="post" action="document.do?method=SendMail<%=param %>" >
...
<table class="tbl_type" border="1" cellspacing="0" summary="회원검색"> 
	<tr> 
		<td>받을 사람</td>
		<td colspan="3">
			<input type="text" name="to" size="78"  value="<%=toAddr %>" readonly="readonly">
		</td>
	</tr>
	<tr> 
		<td>보내는 사람</td>
	...
	<tr> 
		<td>제 목</td>
		<td colspan="3"> 
			<input type="text" name="subj1" size="78" value="">
		</td>
	</tr>
	<tr> 
		<td colspan="4"> 
...
<br>
<form name="upFile" method="post" enctype="multipart/form-data" action="document.do?method=upFile" target="fileUploadFrm" >
